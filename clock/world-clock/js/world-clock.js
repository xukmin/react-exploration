...
class WorldClock extends React.Component {
  ...
  render() {
    ...
    return React.createElement(
      ...
      null,
      'Current time:',
      React.createElement('input', { type: 'text', onChange: this.handleChange, placeholder: '123456', value: this.state.dateNumber }),
      React.createElement('br', null),
      React.createElement(
        'span',
        null,
        'You entered: ' + date.toLocaleString()
      ),
      React.createElement('br', null),
      React.createElement('br', null),
      React.createElement(
        'span',
        null,
        'GMT time : ' + CalculateTime(date, 0)
      ),
      React.createElement('br', null),
      React.createElement(
        'span',
        null,
        'Beijing time: ' + CalculateTime(date, +8)
      )
    );
  }
}